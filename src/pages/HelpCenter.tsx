...
const FAQS = [
  ...
  { q: 'Which languages does Coding Hub support?', a: 'Java, C++, and Python. Write, compile, and run code with live console output, execution metrics, and error diagnostics.' },
...
const GUIDES = [
  ...
  { icon: Code2, title: 'Coding Hub', desc: 'Write, compile, and run Java, C++, and Python.' },
